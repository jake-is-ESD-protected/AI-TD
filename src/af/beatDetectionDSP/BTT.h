...
#define BTT_DEFAULT_XCORR_PULSE_LOCATIONS                                                                                                                                                                                                                                                                                                                                                                      \
    {                                                                                                                                                                                                                                                                                                                                                                                                          \
        0, 1, 1.5, 2, 3, 4, 4.5, 6                                                                                                                                                                                                                                                                                                                                                                             \
    }
#define BTT_DEFAULT_XCORR_PULSE_VALUES                                                                                                                                                                                                                                                                                                                                                                         \
    {                                                                                                                                                                                                                                                                                                                                                                                                          \
        2.0, 1.0, 0.5, 1.5, 1.5, 0.5, 0.5, 0.5                                                                                                                                                                                                                                                                                                                                                                 \
    }
     ...
     */
    BTT *btt_new(int spectral_flux_stft_len, int spectral_flux_stft_overlap, int oss_filter_order, int oss_length, int cbss_length, int onset_threshold_len, double sample_rate, int analysis_latency_onset_adjustment, int analysis_latency_beat_adjustment);
    BTT *btt_new_default();
