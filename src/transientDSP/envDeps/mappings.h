 ...
 * @return T
 */
template <typename T> inline T map_linear_norm_bipolar(const T val_norm, const T out_lo, const T out_hi)
{
 ...
 * @return T
 */
template <typename T> inline T map_linear_norm(const T val_norm, const T out_lo, const T out_hi)
{
 ...
 * @return T
 */
template <typename T> inline T map_linear(const T val, const T in_lo, const T in_hi, const T out_lo, const T out_hi)
{
 ...
 * @return T
 */
template <typename T> inline T normalise(const T val, const T in_lo, const T in_hi)
{
 ...
 * @return T
 */
template <typename T> inline T normalise_bipolar(const T val, const T in_lo, const T in_hi)
{
 ...
 */
template <typename T> inline T unipolar_to_bipolar(T x)
{
 ...
 */
template <typename T> inline T bipolar_to_unipolar(T x)
{
